				...
				<c:forEach var="usuario" items="${usuarios}">
					<tr>
						...
						<td>
							...
							<a href="${urlUsuarios}/delete/${usuario.id}" onclick='return confirm("¿Estas seguro?")' class="btn btn-danger btn-sm" role="button" title="Eliminar"><span class="glyphicon glyphicon-trash"></span></a>
						</td>
					</tr>
				</c:forEach>
			</table>
