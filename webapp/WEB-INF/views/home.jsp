...
<body>
    ...
    ================================================== -->
		...
		<div class="row page-header">
			<div class="col-lg-12">
				<h2 class="text text-center"><span class="label label-success">FIXTURE</span></h2>
			...
			<div class="row">
				<c:forEach var="partido" items="${partidos}">
					 <div class="col-xs-12 col-sm-6 col-md-3">
						 <!-- <img class="img-rounded" src="${urlPublic}/images/" alt="Generic placeholder image" width="150" height="200">-->  
						 <!--  <h4>Resultado</h4>  -->
						<h4>
							 <span class="label label-info">${partido.local.nombreClub}</span> 
							 <span class="label label-success">${partido.puntosLocal}</span> 
					
						</h4>

						<h4>
							 <span class="label label-info">${partido.visita.nombreClub}</span> 
							 <span class="label label-success">${partido.puntosVisita}</span> 
			
						</h4>						
						<p>
							<!--  <a class="btn btn-sm btn-primary" href="${urlRoot}detail/${jornada.id}/${fechaBusqueda}" role="button">Consulta Horarios &raquo;</a> -->							
						</p>
					</div>  
				</c:forEach>				
			</div>
